...
# Use external CloudWatch log group for EKS Cluster
# Log group is managed by the cloudwatch module
...
resource "aws_iam_policy" "alb_ingress_controller" {
  name        = "${var.environment}-alb-ingress-controller-policy"
...
resource "aws_launch_template" "eks_nodes" {
  ...
  # Don't specify instance_type here - let EKS node group handle multiple types
